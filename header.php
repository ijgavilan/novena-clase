...
<title><?php echo $title = "El SIMCE";?></title>
...
<li<?php if((basename($_SERVER['PHP_SELF']))=='page_1.php'){?> class="active" <?php };?>><a href="page_1.php">Comparación promedios</a></li>
<li<?php if((basename($_SERVER['PHP_SELF']))=='page_2.php'){?> class="active" <?php };?>><a href="page_2.php">Por Regiones</a></li>
</ul>
</nav>
</div>
</div>
